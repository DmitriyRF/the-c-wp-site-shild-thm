<?php /* Template Name: Quote form 2.5.1 */
  ...
  $quote_form_title = 'FREE FURNITURE<br> PROJECT MANAGEMENT QUOTE';
  $quote_form_type = "furniture_project_management_quote";
  $quote_form_event = "Furniture_Project_Management";
  $quote_form_number = [
    "dot" => "2.5.1",
    "underscore" => "2_5_1"
  ];
