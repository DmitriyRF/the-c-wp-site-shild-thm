...
function ex_divi_child_theme_setup()
{
    ...
    if (class_exists('ET_Builder_Module')) {
        ...
        class ET_Builder_Module_Service extends ET_Builder_Module
        {
            public function init()
            {
                ...
                $this->vb_support = 'on';
                $this->main_css_element = '%%order_class%%.et_pb_service';
                $this->settings_modal_toggles = array(
                    'general' => array(
                        'toggles' => array(
                            'main_content' => esc_html__('Text (init general settings_modal_toggles)', 'et_builder'),
                            'image' => esc_html__('Image & Icon (init general settings_modal_toggles)', 'et_builder'),
                            'button' => esc_html__('Button (init general settings_modal_toggles)', 'et_builder'),
                        ),
                    ),
                    'advanced' => array(
                        'toggles' => array(
                            'icon_settings' => esc_html__('Image & Icon (init advanced)', 'et_builder'),
                            'text' => array(
                                'title' => esc_html__('Text (init advanced)', 'et_builder'),
                                'priority' => 49,
                            ),
                            'colors' => array(
                                'title' => esc_html__('Colors (init advanced)', 'et_builder'),
                                'priority' => 11,
                            ),
                            'width' => array(
                                'title' => esc_html__('Sizing (init advanced)', 'et_builder'),
                                'priority' => 65,
                            ),
                        ),
                    ),
                    'custom_css' => array(
                        'toggles' => array(
                            'animation' => array(
                                'title' => esc_html__('Animation (init custom_css)', 'et_builder'),
                                'priority' => 90,
                            ),
                            'attributes' => array(
                                'title' => esc_html__('Attributes (init custom_css)', 'et_builder'),
                                'priority' => 95,
                            ),
                        ),
                    ),
                ...
                $this->advanced_fields = array(
                    'fonts' => array(
                        'header' => array(
                            'label' => esc_html__('Title (advanced_fields)', 'et_builder'),
                            'css' => array(
                        ...
                        'body' => array(
                            'label' => esc_html__('Body (advanced_fields)', 'et_builder'),
                            'css' => array(
                    ...
                    'box_shadow' => array(
                        'default' => array(),
                        'image' => array(
                            'label' => esc_html__('Image Box Shadow (advanced_fields)', 'et_builder'),
                ...
                $this->custom_css_fields = array(
                    'service_image' => array(
                        ...
                        'selector' => '.et_pb_main_service_image',
                    ),
                    'service_title' => array(
                    ...
                    'service_content' => array(
                        ...
                        'selector' => '.et_pb_service_content',
                    ),
                );
            ...
            public function get_fields()
            {
                ...
                $fields = array(
                    'title' => array(
                        ...
                        'description' => esc_html__('The title of your service will appear in bold below your service image.', 'et_builder'),
                    ...
                    'link_text' => array(
                        ...
                        'type' => 'text',
                        'option_category' => 'basic_option',
                        'description' => esc_html__('The link text of your service will appear in bold below your service image.', 'et_builder'),
                        'toggle_slug' => 'main_content',
                        'dynamic_content' => 'text',
                    ),
                    'hover_bg_color' => array(
                        ...
                        'type' => 'color-alpha',
                        'description' => esc_html__('Here you can define a custom color for your bg.', 'et_builder'),
                        'depends_show_if' => 'on',
                        'tab_slug' => 'advanced',
                        'toggle_slug' => 'colors',
                        'hover' => 'tabs',
                    ...
                    'url' => array(
                        ...
                        'type' => 'text',
                        'option_category' => 'basic_option',
                        'description' => esc_html__('If you would like to make your service a link, input your destination URL here.', 'et_builder'),
                    ...
                    'font_icon' => array(
                        ...
                        'toggle_slug' => 'image',
                        'description' => esc_html__('Choose an icon to display with your service.', 'et_builder'),
                        'depends_show_if' => 'on',
                    ),
                    'icon_color' => array(
                        'default' => $et_accent_color,
            ...
            public function render($attrs, $content = null, $render_slug)
            {
                ...
                if ('' !== $image_max_width_tablet || '' !== $image_max_width_phone || '' !== $image_max_width || $is_image_svg) {
                    ...
                    $image_max_width_selector = $icon_placement === 'top' && $is_image_svg ? '%%order_class%% .et_pb_main_service_image' : '%%order_class%% .et_pb_main_service_image .et_pb_image_wrap';
                ...
                if ('' !== $content_max_width_tablet || '' !== $content_max_width_phone || '' !== $content_max_width) {
                    ...
                    et_pb_generate_responsive_css($content_max_width_values, '%%order_class%% .et_pb_service_content', 'max-width', $render_slug);
                }
                ...
                $image = $image ? sprintf(
                    '<div class="et_pb_main_service_image%2$s">%1$s</div>',
                    ('' !== $url
                        ? sprintf(
                ...
                $this->add_classname(array(
                    ...
                    sprintf(' et_pb_service_position_%1$s', esc_attr($icon_placement)),
                ));
                ...
                $output = sprintf(
                    '<div%5$s class="%4$s"%8$s%9$s>
                        ...
                        <div class="et_pb_service_content">
                            %2$s
                            <div class="et_pb_service_container">
                            %3$s
                            <div class="et_pb_service_description">
                                %1$s
                            </div><!-- .et_pb_service_description -->
                            </div>
